    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <div class="bg-white py-8 px-6 shadow-lg rounded-2xl">
                <img src="{{ asset('other-images/Lambang_Kab_Kolaka.png') }}" alt="Your Company"
                    class="mx-auto h-30 w-auto" />
                <h2 class="leading-[1] mt-5 text-center text-xl/9 font-bold tracking-tight text-gray-900">Masuk ke Panel Admin<br>GIS Kependudukan</h2>
                ...
                <form action="" method="POST" class="space-y-6 mt-5">
                    @csrf
                    <div>
