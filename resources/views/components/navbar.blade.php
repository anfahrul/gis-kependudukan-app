        ...
        <div class="hidden lg:flex lg:gap-x-12">
            ...
            <div class="relative">
                <button type="button" @click="isOpen = !isOpen"
                    ...
                    Data Demografi
                    <svg :class="{ 'rotate-180': isOpen, '': !isOpen }" class="size-5 flex-none text-gray-400"
                ...
                <div x-show="isOpen" x-transition:enter="transition ease-out duration-200"
                    ...
                    <div class="p-4">
                        <div
                            ...
                            <div class="flex-auto">
                                <a href="/demografi/agama" class="block font-semibold text-gray-900">
                                    Agama
                        ...
                        <div
                            ...
                            <div class="flex-auto">
                                <a href="/demografi/golongan-darah" class="block font-semibold text-gray-900">
                                    Golongan Darah
                                    <span class="absolute inset-0"></span>
                                </a>
                        ...
                        <div
                            ...
                            <div class="flex-auto">
                                <a href="/demografi/jenis-kelamin" class="block font-semibold text-gray-900">
                                    Jenis Kelamin
                                    <span class="absolute inset-0"></span>
                                </a>
        ...
        <div
            ...
            <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-gray-500/10">
                    ...
                    -->
                                <svg :class="{ 'rotate-180': isOpen, '': !isOpen }" class="size-5 flex-none"
                                    viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
                                    <path fill-rule="evenodd"
                                        d="M5.22 8.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 1 1 1.06 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 9.28a.75.75 0 0 1 0-1.06Z"
                                        clip-rule="evenodd" />
                            ...
                            <div x-show="isOpen" class="mt-2 space-y-2" id="products">
                                <a href="#"
